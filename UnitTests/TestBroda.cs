...
namespace UnitTests
{
    ...
    public class TestBroda
    {
        ...
        public void Brod_GadjajVracaPromasajZaPoljeKojeNijeUBrodu()
        {
            ...
            Assert.AreEqual(RezultatGadjanja.Promasaj, b.Gadjaj(new Polje(2, 3)));
        }
        ...
        public void Brod_GadjajVracaPogodakZaPoljeKojeJeUBrodu()
        {
            Polje[] polja = { new Polje(1, 2), new Polje(1, 3), new Polje(1, 4) };
            Brod b = new Brod(polja);
            Assert.AreEqual(RezultatGadjanja.Pogodak, b.Gadjaj(new Polje(1, 2)));
        }
        ...
        public void Brod_GadjajVracaPotonuceZaZadnjePoljeKojeJeUBrodu()
        {
            ...
            Brod b = new Brod(polja);
            Assert.AreEqual(RezultatGadjanja.Pogodak, b.Gadjaj(new Polje(1, 2)));
            Assert.AreEqual(RezultatGadjanja.Pogodak, b.Gadjaj(new Polje(1, 3)));
            Assert.AreEqual(RezultatGadjanja.Potonuce, b.Gadjaj(new Polje(1, 4)));
        ...
        public void Brod_GadjajVracaPotonuceZaZadnjePoljeKojeJePonovnoGadjano()
        {
            ...
            Brod b = new Brod(polja);
            Assert.AreEqual(RezultatGadjanja.Pogodak, b.Gadjaj(new Polje(1, 2)));
            Assert.AreEqual(RezultatGadjanja.Pogodak, b.Gadjaj(new Polje(1, 4)));
            Assert.AreEqual(RezultatGadjanja.Potonuce, b.Gadjaj(new Polje(1, 3)));
            Assert.AreEqual(RezultatGadjanja.Potonuce, b.Gadjaj(new Polje(1, 4)));
